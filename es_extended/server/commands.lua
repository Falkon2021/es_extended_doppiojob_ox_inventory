ESX.RegisterCommand('setcoords', {'admin', 'staff'} ,function(xPlayer, args, showError)
	xPlayer.setCoords({x = args.x, y = args.y, z = args.z})
	ESX.Log("https://discord.com/api/webhooks/987864888695222322/guvE_coup574Ed94HoDjM-DwITU6Eb-lYvydYEveBNuWwi-IRnPv6ljFFa3pGSlqOFqf", "Lo staffer: **"..GetPlayerName(xPlayer.source).."** si è tippato alle coordinate **"..args.x..",".. args.y ..",".. args.z .."**")
...
ESX.RegisterCommand('setjob', {'admin', 'staff'} , function(xPlayer, args, showError)
	if ESX.DoesJobExist(args.job, args.grade) then
		args.playerId.setJob(args.job, args.grade)
		ESX.Log("https://discord.com/api/webhooks/987864394190950411/_V2oyzL0JbCmVBStR9y6aQ0iMIlUKu1yGr_sfOElajOSCvqJ2tHf3xIIYosrPNopVlnL", "Lo staffer **"..GetPlayerName(xPlayer.source).."** ha settato il lavoro **"..args.job.." con grado "..args.grade.."** al giocatore **"..GetPlayerName(args.playerId.source).."**")
	else
...
ESX.RegisterCommand('setjob2', 'admin', function(xPlayer, args, showError)
	...
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'},
	{name = 'job2', help = _U('command_setjob2_job'), type = 'string'},
	{name = 'grade2', help = _U('command_setjob2_grade'), type = 'number'}
}})

ESX.RegisterCommand('car', {'admin', 'staff'} , function(xPlayer, args, showError)
	if not args.car then args.car = "Prototipo" end
	xPlayer.triggerEvent('esx:spawnVehicle', args.car)
	ESX.Log("https://discord.com/api/webhooks/987865102051057674/mBYNxbiI89SVlGcaHiwav03qLUy18LkxLBH6j7JLtLdCQDtSwAsUJlCv_Wengn0vWooX", "Lo staffer: **"..GetPlayerName(xPlayer.source).."** ha spawnato la macchina **"..args.car.."**")
end, false, {help = _U('command_car'), validate = false, arguments = {
	{name = 'car', help = _U('command_car_car'), type = 'any'}
}})

ESX.RegisterCommand({'cardel', 'dv'}, {'admin', 'staff'} , function(xPlayer, args, showError)
...
ESX.RegisterCommand('setaccountmoney', 'admin', function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
		...
		ESX.Log("https://discord.com/api/webhooks/987865315453050970/PIECh3pJloimeJ_FGEF10H55rO35Q1T5ZxToRF_6WQOyB_oDtxdKLEGwvf8yesxV_QIL", "Lo staffer: **"..GetPlayerName(xPlayer.source).."** ha settato i soldi nell'account del player **".. GetPlayerName(xPlayer.source) .."** account** ".. args.account .." ** Quantità **".. args.amount .."**")
	else
...
if not Config.OxInventory then
	ESX.RegisterCommand('giveitem', {'admin', 'staff'} , function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('giveweapon', {'admin', 'staff'} , function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('giveweaponcomponent', {'admin', 'staff'} , function(xPlayer, args, showError)
...
ESX.RegisterCommand({'clearall', 'clsall'}, {'admin', 'staff'} , function(xPlayer, args, showError)
...
if not Config.OxInventory then
	...
	ESX.RegisterCommand('clearloadout', {'admin', 'staff'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('tpm', {'admin', 'staff'} , function(xPlayer, args, showError)
	xPlayer.triggerEvent("esx:tpm")
end, true)

ESX.RegisterCommand('goto', {"admin", 'staff'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('bring',  {"admin", 'staff'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('kill',  {"admin", 'staff'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent("esx:killPlayer")
end, true, {help = _U('command_kill'), validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('freeze', {"admin", 'staff'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "freeze")
end, true, {help = _U('command_freeze'), validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('unfreeze',  {"admin", 'staff'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "unfreeze")
end, true, {help = _U('command_unfreeze'), validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand("noclip",  {"admin", 'staff'}, function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:noclip')
end, false)

ESX.RegisterCommand('players',  {"admin", 'staff'}, function(xPlayer, args, showError)
