...
RegisterNetEvent('esx:setDuty2')
AddEventHandler('esx:setDuty2', function(bool)
    local xPlayer = ESX.GetPlayerFromId(source)
    if xPlayer.jo2.onDuty == bool then
        return
    end
    ...
    TriggerClientEvent('esx:setJob2', xPlayer.source, xPlayer.job2)
end)
